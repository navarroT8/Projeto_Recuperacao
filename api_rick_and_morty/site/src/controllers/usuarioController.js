...
function gravar_quiz(req, res){
    ...
    if (acerto == undefined) {
        ...
        // Passe os valores como parâmetro e vá para o arquivo usuarioModel.js
        usuarioModel.gravar_quiz(acerto, erro, usuario)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
...
function buscar_quiz(req, res) {
    ...
    if (idUsuario == undefined) {
        ...
        // Passe os valores como parâmetro e vá para o arquivo usuarioModel.js
        usuarioModel.buscar_quiz(idUsuario)
            .then(
                function (resultado) {
                    res.status(200).json(resultado);
                }
                ...
                function (erro) {
                    console.log(erro);
                    console.log(
                        "\nHouve um erro ao realizar ao buscar os resultados do quiz! Erro: ",
                        erro.sqlMessage
                    );
                    res.status(500).json(erro.sqlMessage);
                }
...
function buscar_ranking(req, res) {
    usuarioModel.buscar_ranking()
        .then(
            function (resultado) {
                res.status(200).json(resultado);
            }
